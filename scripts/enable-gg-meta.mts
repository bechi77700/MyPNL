...
const { error } = await admin.from("ad_accounts").update({ enabled: true }).eq("id", "66f9e414-08fd-4191-a406-1e1197d81a1c");
console.log("compte GARDEN GATHER active :", error ?? "ok");
