...
const ICONES: Record<string, React.ReactNode> = {
  ...
  payments: <><rect x="2" y="4" width="14" height="10" rx="2" {...T} /><path d="M2 7.5h14M5 11h3" {...T} /></>,
  chargebacks: <><path d="M9 2.5 15.5 14H2.5z" {...T} /><path d="M9 7v3.2M9 12.2v.1" {...T} /></>,
...
const SECTIONS: {
...
}[] = [
  {
    ...
    liens: [
      ...
      { href: "/payments", label: "Payments", icone: "payments" },
      { href: "/chargebacks", label: "Chargebacks", icone: "chargebacks" },
